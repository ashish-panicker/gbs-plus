...
public class BatchConfig {
    ...
    public FlatFileItemReader<MatchInput> reader() {
        ...
        return new FlatFileItemReaderBuilder<MatchInput>().name("matchDataProcessor")
                .resource(new ClassPathResource("matches.csv")).delimited().names(FIELD_NAMES)
    ...
    public JdbcBatchItemWriter<Match> writer(DataSource dataSource) {
        ...
        return new JdbcBatchItemWriterBuilder<Match>()
                ...
                .sql("INSERT INTO matches "
                        + "(id,city,match_date,player_of_match,venue,nuetral_venue,team1,team2,toss_winner," 
                        + "toss_decision,winner,result,result_margin,eliminator,method,umpire1,umpire2) "
                        + "VALUES " 
                        + "(:id,:city,:matchDate,:playerOfMatch,:venue,:nuetralVenue,:team1,:team2,:tossWinner," 
